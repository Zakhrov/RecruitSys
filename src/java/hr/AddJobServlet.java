...
public class AddJobServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            PreparedStatement AddnewJob=db.conn.prepareStatement("insert into jobs(job_min_qual,job_name,job_desc) Values(?,?,?)");
            AddnewJob.setString(1, request.getParameter("job_qual"));
            AddnewJob.setString(2, request.getParameter("job_name"));
            AddnewJob.setString(3, request.getParameter("job_desc"));
